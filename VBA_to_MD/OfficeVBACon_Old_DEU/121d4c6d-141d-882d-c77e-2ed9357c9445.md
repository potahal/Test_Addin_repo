...
# CommandBarButton.Visible-Eigenschaft (Office)

Dient zum Abrufen oder festlegen die  **Visible** -Eigenschaft des **CommandBarButton** -Steuerelement. **True,** Wenn die **CommandBarButton** angezeigt wird. Lese-/Schreibzugriff.
