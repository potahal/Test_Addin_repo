...
---
ms.Toctitle:Label.Picture プロパティ (Outlook フォーム スクリプト)
title:Label.Picture プロパティ (Outlook フォーム スクリプト)
ms.ContentId:31d2f254-abce-fe6a-b6f1-a625606e5893
---
# Label.Picture プロパティ (Outlook フォーム スクリプト)
