...
# TextRange2.RtlRun-Methode (Office)

Gibt ein  **TextRange2** -Objekt, das die angegebene Untermenge von rechts-nach-links-Textläufe darstellt. Einen Textlauf besteht aus einem Bereich von Zeichen, die dieselben Schriftattribute aufweisen.
