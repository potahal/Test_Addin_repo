...
|**pjTaskPathDrivenSuccessor**|188745063|タスクのパスの被駆動の後続フィールドです。 **[Task.PathDrivenSuccessor](ec77b34e-a98c-142e-14ba-868ff93deaad.md)** プロパティを参照してください。|
|**pjTaskPathDrivingPredecessor**|188745061|タスクのパスの駆動の先行タスク フィールドです。 **[Task.PathDrivingPredecessor](c78f744e-ed0d-8923-fb01-a0e40a14726f.md)** プロパティを参照してください。|
|**pjTaskPathPredecessor**|188745062|タスクの先行タスク フィールドです。 **[Task.PathPredecessor](f0662677-cab5-10e2-e18c-fc291bfca28b.md)** プロパティを参照してください。|
...
多くのプロパティ、メソッド、およびイベントは、  **PjField**列挙体を使用します。たとえば、  **Resource**オブジェクトと **Task**オブジェクト、 [SetResourceFieldByID](1309ee61-6b66-db45-ed69-b0b3dd9b8dda.md)メソッドと[SetTaskFieldByID](b4c74d96-d25b-707e-15f1-5e7f05363360.md)メソッドの **SetField**メソッドと **GetField**メソッドを参照してください。フィールド名とフィールドの定数値との間の変換には、 [FieldConstantToFieldName](b8e55035-64e8-fda5-4ad6-9f5e51a55181.md)メソッドと[FieldNameToFieldConstant](0830db06-22a7-3ca5-c9ca-f9efbc360767.md)メソッドを参照してください。
