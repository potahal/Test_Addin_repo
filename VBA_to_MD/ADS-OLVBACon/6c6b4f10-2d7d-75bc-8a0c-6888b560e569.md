...
---
ms.Toctitle:Outlook の COM アドイン テンプレート
title:Outlook の COM アドイン テンプレート
ms.ContentId:6c6b4f10-2d7d-75bc-8a0c-6888b560e569
---
...
次のコード例は、COM アドインの実装に必要な空のイベント プロシージャです。
