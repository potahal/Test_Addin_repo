...
---
ms.Toctitle:ScrollBar.BackColor プロパティ (Outlook フォーム スクリプト)
title:ScrollBar.BackColor プロパティ (Outlook フォーム スクリプト)
ms.ContentId:b87d125a-f568-99c4-6018-2d60639a943b
---
# ScrollBar.BackColor プロパティ (Outlook フォーム スクリプト)
