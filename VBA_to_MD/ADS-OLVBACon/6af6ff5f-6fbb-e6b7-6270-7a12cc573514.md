...
---
ms.Toctitle:TimelineView.ShowLabelWhenViewingByMonth プロパティ (Outlook)(機械翻訳)
title:TimelineView.ShowLabelWhenViewingByMonth プロパティ (Outlook)(機械翻訳)
ms.ContentId:6af6ff5f-6fbb-e6b7-6270-7a12cc573514
---
# TimelineView.ShowLabelWhenViewingByMonth プロパティ (Outlook)(機械翻訳)




**TimelineView**オブジェクトの月を表示するときに Outlook アイテムのラベルが表示されるかどうかを決定する**ブール**値を設定を取得または取得します。読み取り/書き込み。

## 構文

            UNRESOLVED_TOKEN_VAL(offexpression).**ShowLabelWhenViewingByMonth**
...
## 注釈
このプロパティは、 **TimelineViewMode**プロパティを**olTimelineViewMonth**に設定されている場合にのみに適用します。
