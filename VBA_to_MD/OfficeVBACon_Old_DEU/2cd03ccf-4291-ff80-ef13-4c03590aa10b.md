...
# SignatureInfo.SignatureComment-Eigenschaft (Office)

Ruft einen Wert ab, der Kommentare enthält, die in einem Signaturpaket enthalten sind, oder legt diesen Wert fest. Lese-/Schreibzugriff.


## Syntax

 _Ausdruck_. **SignatureComment**
