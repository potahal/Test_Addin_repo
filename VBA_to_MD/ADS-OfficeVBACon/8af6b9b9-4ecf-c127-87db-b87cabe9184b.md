...
---
ms.Toctitle:TextRange2.BoundLeft プロパティ (Office)
title:TextRange2.BoundLeft プロパティ (Office)
ms.ContentId:8af6b9b9-4ecf-c127-87db-b87cabe9184b
---
# TextRange2.BoundLeft プロパティ (Office)
...
## 構文
            ...
            UNRESOLVED_TOKEN_VAL(offexpression).**BoundLeft**
