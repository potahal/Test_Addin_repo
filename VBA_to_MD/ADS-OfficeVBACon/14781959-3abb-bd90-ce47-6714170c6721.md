...
---
ms.Toctitle:Crop.PictureWidth プロパティ (Office)
title:Crop.PictureWidth プロパティ (Office)
ms.ContentId:14781959-3abb-bd90-ce47-6714170c6721
---
# Crop.PictureWidth プロパティ (Office)




トリミングされるイメージの幅を取得または設定します。値の取得および設定が可能です。

## 構文

            UNRESOLVED_TOKEN_VAL(offexpression).**PictureWidth**
