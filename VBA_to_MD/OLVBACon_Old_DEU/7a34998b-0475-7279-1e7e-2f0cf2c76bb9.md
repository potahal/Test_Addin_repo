...
Gibt eine  **Zeichenfolge**, die den Anzeigenamen des Benutzers zur Darstellung des Empfängers der e-Mail-Nachricht darstellt. Schreibgeschützt.


## Syntax

 _Ausdruck_. **ReceivedOnBehalfOfName**
...
Diese Eigenschaft entspricht der MAPI-Eigenschaft  **PidTagReceivedRepresentingName**.
