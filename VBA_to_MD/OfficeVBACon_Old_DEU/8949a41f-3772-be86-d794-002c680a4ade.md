...
# CommandBarPopup.Top-Eigenschaft (Office)

Ruft den Abstand (in Pixeln) vom oberen Rand des angegebenen  **CommandBarPopup** -Steuerelement zum oberen Rand des Bildschirms. Schreibgeschützt.
