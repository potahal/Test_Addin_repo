...
---
ms.Toctitle:CommandBarComboBox.HelpContextId プロパティ (Office)
title:CommandBarComboBox.HelpContextId プロパティ (Office)
ms.ContentId:3b34572b-af1b-a4fc-a98e-23d51315a077
---
# CommandBarComboBox.HelpContextId プロパティ (Office)




取得または**戻します**コントロールに関連付けるヘルプ トピックの Id 番号のヘルプ コンテキストを設定します。読み取り/書き込み。
