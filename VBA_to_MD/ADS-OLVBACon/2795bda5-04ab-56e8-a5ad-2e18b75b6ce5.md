...
---
ms.Toctitle:Label.BackColor プロパティ (Outlook フォーム スクリプト)
title:Label.BackColor プロパティ (Outlook フォーム スクリプト)
ms.ContentId:2795bda5-04ab-56e8-a5ad-2e18b75b6ce5
---
# Label.BackColor プロパティ (Outlook フォーム スクリプト)
