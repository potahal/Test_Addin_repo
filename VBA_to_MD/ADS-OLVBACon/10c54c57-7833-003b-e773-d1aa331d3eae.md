...
---
ms.Toctitle:MultiPage.BackColor プロパティ (Outlook フォーム スクリプト)
title:MultiPage.BackColor プロパティ (Outlook フォーム スクリプト)
ms.ContentId:10c54c57-7833-003b-e773-d1aa331d3eae
---
# MultiPage.BackColor プロパティ (Outlook フォーム スクリプト)
