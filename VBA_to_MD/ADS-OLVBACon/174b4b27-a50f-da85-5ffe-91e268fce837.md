...
---
ms.Toctitle:Image.SpecialEffect プロパティ (Outlook フォーム スクリプト)
title:Image.SpecialEffect プロパティ (Outlook フォーム スクリプト)
ms.ContentId:174b4b27-a50f-da85-5ffe-91e268fce837
---
# Image.SpecialEffect プロパティ (Outlook フォーム スクリプト)
...
|**値**|**説明**|
|---|---|
|0|オブジェクトは平面的に表示され、境界線や色の違いによって背景と区別されます。**Image** の既定値。|
