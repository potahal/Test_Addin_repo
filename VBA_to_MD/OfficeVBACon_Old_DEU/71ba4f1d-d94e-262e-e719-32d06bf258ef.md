...
# Crop.PictureOffsetX-Eigenschaft (Office)

Hiermit wird der Offset für die X-Achse des zuzuschneidenden Bilds abgerufen oder festgelegt. Lese-/Schreibzugriff.


## Syntax

 _Ausdruck_. **PictureOffsetX**
 ...
 **OffsetX** und **OffsetY** sind relativ zur Mitte der Form und des Bilds.
