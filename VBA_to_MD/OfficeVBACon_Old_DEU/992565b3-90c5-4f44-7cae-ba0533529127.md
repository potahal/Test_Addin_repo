...
# ODSOFilter.Comparison-Eigenschaft (Office)

Dient zum Abrufen oder festlegen eine  **MsoFilterComparison** -Konstanten, die wie die Eigenschaften **Column** und **CompareTo** verglichen darstellt. Lese-/Schreibzugriff.


## Syntax

 _Ausdruck_. **Comparison**
