...
# CommandBarPopup.Id-Eigenschaft (Office)

Ruft die ID für ein integriertes  **CommandBarPopup** -Steuerelement. Schreibgeschützt.
...
Die ID eines Popups bestimmt die integrierte Aktion für dieses Objekts.
