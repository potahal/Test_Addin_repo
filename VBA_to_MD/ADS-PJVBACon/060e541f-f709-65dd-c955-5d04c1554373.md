...
---
ms.Toctitle:Year オブジェクト (Project)
title:Year オブジェクト (Project)
ms.ContentId:060e541f-f709-65dd-c955-5d04c1554373
---
# Year オブジェクト (Project)
...
プロジェクト カレンダーにおける年を表します。**Year**オブジェクトは、**数年**のコレクションのメンバーです。
