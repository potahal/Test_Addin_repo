...
---
ms.Toctitle:ComboBox.BackColor プロパティ (Outlook フォーム スクリプト)
title:ComboBox.BackColor プロパティ (Outlook フォーム スクリプト)
ms.ContentId:a417035a-8164-9cde-a1b4-40f481938000
---
# ComboBox.BackColor プロパティ (Outlook フォーム スクリプト)
