...
---
ms.Toctitle:ListBox.TextAlign プロパティ (Outlook フォーム スクリプト)
title:ListBox.TextAlign プロパティ (Outlook フォーム スクリプト)
ms.ContentId:b6c7232c-feef-d43b-ca4f-d8521ddd50ff
---
# ListBox.TextAlign プロパティ (Outlook フォーム スクリプト)
