...
# Font2.SoftEdgeFormat-Eigenschaft (Office)

Ruft einen Wert ab oder legt einen solchen fest, der den Typ von weicher Kante angibt, der in einer Textauswahl verwendet wird. Lese-/Schreibzugriff.


## Syntax

 _Ausdruck_. **SoftEdgeFormat**
