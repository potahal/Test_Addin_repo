...
---
ms.Toctitle:Crop.ShapeHeight プロパティ (Office)
title:Crop.ShapeHeight プロパティ (Office)
ms.ContentId:ccc352b8-2c1e-3116-6f50-a709760189fe
---
# Crop.ShapeHeight プロパティ (Office)




イメージのトリミングに使用する図形の高さを取得または設定します。値の取得および設定が可能です。

## 構文

            UNRESOLVED_TOKEN_VAL(offexpression).**ShapeHeight**
