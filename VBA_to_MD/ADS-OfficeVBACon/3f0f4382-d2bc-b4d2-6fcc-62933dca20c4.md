...
---
ms.Toctitle:Crop.ShapeLeft プロパティ (Office)
title:Crop.ShapeLeft プロパティ (Office)
ms.ContentId:3f0f4382-d2bc-b4d2-6fcc-62933dca20c4
---
...
イメージのトリミングに使用する図形の左の位置を取得または設定します。値の取得および設定が可能です。

## 構文

            UNRESOLVED_TOKEN_VAL(offexpression).**ShapeLeft**
