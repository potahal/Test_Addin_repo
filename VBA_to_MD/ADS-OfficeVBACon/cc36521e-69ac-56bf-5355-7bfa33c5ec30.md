...
---
ms.Toctitle:Crop.PictureOffsetY プロパティ (Office)
title:Crop.PictureOffsetY プロパティ (Office)
ms.ContentId:cc36521e-69ac-56bf-5355-7bfa33c5ec30
---
# Crop.PictureOffsetY プロパティ (Office)




トリミングされるイメージの Y 軸オフセットを取得または設定します。値の取得および設定が可能です。

## 構文

            UNRESOLVED_TOKEN_VAL(offexpression).**PictureOffsetY**
