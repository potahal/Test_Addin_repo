...
---
ms.Toctitle:Month.Count プロパティ (Project)
title:Month.Count プロパティ (Project)
ms.ContentId:cf17523e-9b43-ee38-3c45-15936e8d0559
---
# Month.Count プロパティ (Project)




**Month**オブジェクト内の日数を取得します。読み取り専用**の整数**です。
