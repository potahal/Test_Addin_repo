...
# FileDialog.InitialView-Eigenschaft (Office)

Ruft eine  **MsoFileDialogView** -Konstante ab, die die anfängliche Darstellung von Dateien und Ordnern in einem Dateidialogfeld darstellt, oder legt sie fest. Lese-/Schreibzugriff.


## Syntax

 _Ausdruck_. **InitialView**
