...
# CommandBarControl.Top-Eigenschaft (Office)

Ruft den Abstand (in Pixel) vom oberen Rand des angegebenen  **CommandBarControl-Objekt** zum oberen Rand des Bildschirms. Schreibgeschützt.
