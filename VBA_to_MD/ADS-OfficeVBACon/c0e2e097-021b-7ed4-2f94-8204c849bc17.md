...
---
ms.Toctitle:PickerResults オブジェクト (Office)
title:PickerResults オブジェクト (Office)
ms.ContentId:c0e2e097-021b-7ed4-2f94-8204c849bc17
---
# PickerResults オブジェクト (Office)




**PickerResult**オブジェクトのコレクションです。

## 注釈
各**PickerResult**オブジェクトでは、解決済みまたは選択した項目のデータを表します。



## 例
次のコードは、選択ダイアログを表示し、結果を取得して、それらの結果を列挙します。
