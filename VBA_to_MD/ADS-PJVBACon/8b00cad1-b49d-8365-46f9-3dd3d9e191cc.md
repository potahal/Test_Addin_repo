...
---
ms.Toctitle:LookupTable.Count プロパティ (Project)
title:LookupTable.Count プロパティ (Project)
ms.ContentId:8b00cad1-b49d-8365-46f9-3dd3d9e191cc
---
# LookupTable.Count プロパティ (Project)




**LookupTable**コレクション内の項目数を取得します。
