...
---
ms.Toctitle:Frame.BackColor プロパティ (Outlook フォーム スクリプト)
title:Frame.BackColor プロパティ (Outlook フォーム スクリプト)
ms.ContentId:65b9ece4-bac7-dcb6-5f96-e321a11bfc94
---
# Frame.BackColor プロパティ (Outlook フォーム スクリプト)
