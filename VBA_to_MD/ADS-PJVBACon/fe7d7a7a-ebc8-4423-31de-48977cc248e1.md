...
---
ms.Toctitle:Cell.FieldID プロパティ (Project)
title:Cell.FieldID プロパティ (Project)
ms.ContentId:fe7d7a7a-ebc8-4423-31de-48977cc248e1
---
# Cell.FieldID プロパティ (Project)




アクティブ セルのタスクまたはリソース フィールドの id 番号を取得します。読み取り専用**Long**です。
...
## 注釈
アクティブ セルの内容がタスクである場合、使用できる定数は、次に示す **PjField** クラスの定数のいずれかです。
...
アクティブ セルの内容がリソースである場合、使用できる定数は、次に示す **PjField** クラスの定数のいずれかです。
